...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container">
			<a class="navbar-brand" href="#"><font color=blue>CRUD PHP</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item">
						<a class="nav-link" href="tambah.php" style="color:blue">Tambah</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="container" style="margin-top:20px"><font color=yellow>
		<h2>Data</h2>
